...
void TextRenderer::RenderText(GLfloat* textWidth, GLfloat* textHight, std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color)
{
	...
	*textHight = 0;
	...
	for (c = text.begin(); c != text.end(); c++)
	{
		...
		*textHight = max(*textHight, (this->Characters['H'].Bearing.y - ch.Bearing.y) * scale);
